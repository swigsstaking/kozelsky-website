  ...
  return (
    <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {c.values.map((value, index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-lg font-serif text-white mb-2">{value.title}</h3>
                <p className="text-secondary-400 text-sm">{value.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-secondary-800">
        <div className="container-site">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-serif text-white mb-8">{c.dreamers}</h2>
            <p className="text-xl text-secondary-300 leading-relaxed mb-12">{c.dreamersDesc}</p>

            <div className="w-24 h-px bg-accent-400 mx-auto my-12" />

            <h2 className="text-4xl md:text-5xl font-serif text-white mb-8">{c.madeIt}</h2>
            <p className="text-xl text-secondary-300 leading-relaxed">{c.madeItDesc}</p>
          </div>
        </div>
      </section>

      {/* Kozelsky Catering - Light contrast */}
      <section className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center bg-cream text-secondary-900 p-12 lg:p-20">
          <div>
            <p className="text-accent-600 uppercase tracking-[0.3em] text-sm mb-6">{c.companyCreation}</p>
            <h2 className="text-4xl font-serif mb-6">{c.kozelsky}</h2>
            <p className="text-secondary-600 leading-relaxed mb-8">{c.kozelskyCateringDesc}</p>
            <Link
              to="/catering"
