      ...
      <section className="py-32 bg-cream">
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-4xl mx-auto">
            <div className="text-center bg-white p-12 rounded-3xl">
              <h3 className="text-3xl font-serif text-secondary-900 mb-6">{c.modular}</h3>
              <p className="text-secondary-600 text-lg">{c.modularDesc}</p>
            </div>
            <div className="text-center bg-white p-12 rounded-3xl">
              <h3 className="text-3xl font-serif text-secondary-900 mb-6">{c.refined}</h3>
              <p className="text-secondary-600 text-lg">{c.refinedDesc}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-secondary-900 text-white">
        <div className="container-site">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl font-serif mb-8">{c.lowerDeck}</h2>
            <p className="text-secondary-300 max-w-2xl mx-auto text-lg">{c.lowerDeckDesc}</p>
          </div>
      ...
      <section className="py-32 bg-cream">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <p className="text-accent-600 uppercase tracking-[0.3em] text-sm mb-6">{c.firstFloor}</p>
              <h2 className="text-5xl font-serif text-secondary-900 mb-8">{c.upperDeck}</h2>
              <p className="text-secondary-600 leading-relaxed text-lg mb-10">{c.upperDeckDesc}</p>
              <ul className="space-y-5">
                {c.upperDeckFeatures.map((feature, index) => (
                  <li key={index} className="flex items-start gap-4">
                    ...
                    <span className="text-secondary-600 text-lg">{feature}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link to="/bus-11-97/v4/services" className="group p-10 bg-cream rounded-3xl hover:bg-secondary-900 transition-colors text-center">
            ...
            <Link to="/bus-11-97/v4/team" className="group p-10 bg-cream rounded-3xl hover:bg-secondary-900 transition-colors text-center">
              <h3 className="text-2xl font-serif text-secondary-900 group-hover:text-white mb-3 transition-colors">
                {c.navTeam}
              </h3>
              <p className="text-secondary-600 group-hover:text-secondary-300 transition-colors">
            ...
            <Link to="/bus-11-97/v4/history" className="group p-10 bg-cream rounded-3xl hover:bg-secondary-900 transition-colors text-center">
              <h3 className="text-2xl font-serif text-secondary-900 group-hover:text-white mb-3 transition-colors">
                {c.navHistory}
              </h3>
              <p className="text-secondary-600 group-hover:text-secondary-300 transition-colors">
