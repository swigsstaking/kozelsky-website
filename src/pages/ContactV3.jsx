        ...
        <div className="min-h-screen flex items-center justify-center bg-cream py-24">
          <div className="container-site">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <a
                href="/"
                className="inline-flex items-center gap-2 px-8 py-3 bg-secondary-900 text-white hover:bg-secondary-800 transition-colors"
              >
                {c.backToHome}
                <ArrowRight size={18} />
              </a>
      ...
      <div className="min-h-screen bg-cream pt-24">
        ...
        <div className="bg-white border-b border-secondary-200">
          <div className="flex flex-col lg:flex-row">
            <div className="flex-1 lg:max-w-[65%] px-6 lg:px-10 py-6">
        ...
        <div className="flex flex-col lg:flex-row min-h-[calc(100vh-180px)]">
          {/* Main Content - 65% */}
          <div className="flex-1 lg:max-w-[65%] px-6 lg:px-10 py-10">
            <div className="max-w-3xl">
              {/* Step 1: Event Type */}
              {step === 1 && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-3xl font-serif text-secondary-900 mb-3">
                      {c.step1Title}
                    </h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {EVENT_TYPES.map((type) => (
                      <button
                        ...
                        className={`p-6 border-2 text-left transition-all hover:border-accent-600 hover:shadow-lg ${
                          formData.eventType === type.id
                            ? 'border-accent-600 bg-accent-50'
                            : 'border-secondary-200 bg-white'
                        }`}
                      >
                        <h3 className="text-xl font-serif text-secondary-900 mb-2">
                          {type.label}
                        </h3>
                        <p className="text-sm text-secondary-600">{type.desc}</p>
                      </button>
                    ))}
                  </div>
                </div>
                        ...
                        <button
                          ...
                          className={`p-4 border-2 text-left transition-all flex items-center gap-3 ${
                            formData.serviceType === service.id
                              ? 'border-accent-600 bg-accent-50'
                              : 'border-secondary-200 bg-white hover:border-accent-400'
                          }`}
                        >
                          <service.icon size={20} className="text-accent-600" />
                          <span className="text-secondary-900">{service.label}</span>
                        </button>
                      ))}
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
                      {GUEST_RANGES.map((range) => (
                        ...
                        >
                          ...
                          <div className="text-xs text-secondary-600">{range.label}</div>
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-secondary-300 focus:border-accent-600 focus:outline-none"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-secondary-700 mb-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 border border-secondary-300 focus:border-accent-600 focus:outline-none resize-none"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-white p-8 border border-secondary-200 space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-secondary-600 text-sm">{formData.email} • {formData.phone}</p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-accent-600 text-white hover:bg-accent-700 transition-colors disabled:opacity-50"
                  >
              ...
              {/* Navigation Buttons */}
              <div className="flex items-center justify-between mt-12 pt-8 border-t border-secondary-200">
                {step > 1 && (
                  <button
                    onClick={prevStep}
                    className="inline-flex items-center gap-2 px-6 py-3 border-2 border-secondary-300 text-secondary-700 hover:border-secondary-400 transition-colors"
                  >
                    <ArrowLeft size={18} />
                    {c.back}
                  </button>
                ...
                {step < 4 && (
                  <button
                    onClick={nextStep}
                    disabled={!canProceed()}
                    className={`inline-flex items-center gap-2 px-8 py-3 transition-colors ml-auto ${
                      canProceed()
          ...
          {/* Sidebar - 35% */}
          <div className="lg:w-[35%] bg-secondary-900 text-white p-8 lg:p-10">
            <div className="sticky top-32">
              <h3 className="text-2xl font-serif mb-8">{c.yourConfig}</h3>
