...
const BusV2 = () => {
  ...
  return (
    <>
      ...
      {/* Presented by */}
      <section ref={contentRef} className="py-16 bg-cream">
        <div className="container-site flex flex-col items-center">
          ...
          />
          <p className="text-secondary-600 text-center max-w-2xl">
            {c.presentedBy}
          </p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center bg-cream p-12 lg:p-20">
          <div>
            ...
            <Link
              to="/bus-11-97/v2/history"
              className="inline-flex items-center gap-3 text-secondary-900 font-medium group"
            >
              <span className="uppercase tracking-wider text-sm">{c.discoverHistory}</span>
              <span className="w-12 h-px bg-secondary-900 group-hover:w-20 transition-all" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-cream">
        <div className="container-site">
          <div className="text-center mb-16">
            <p className="text-accent-600 uppercase tracking-[0.3em] text-sm mb-4">Services</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link to="/bus-11-97/v2/equipment" className="group bg-white p-8 hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-serif text-secondary-900 mb-4 group-hover:text-accent-600 transition-colors">
                {c.equipment}
              </h3>
              <p className="text-secondary-600 mb-6">
                {c.equipmentDesc}
              </p>
              <span className="inline-flex items-center gap-2 text-accent-600 text-sm">
                {c.discover} <ArrowRight size={14} />
              </span>
            </Link>

            <Link to="/bus-11-97/v2/services" className="group bg-white p-8 hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-serif text-secondary-900 mb-4 group-hover:text-accent-600 transition-colors">
                {c.services}
              </h3>
              <p className="text-secondary-600 mb-6">
            ...
            <Link to="/bus-11-97/v2/team" className="group bg-white p-8 hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-serif text-secondary-900 mb-4 group-hover:text-accent-600 transition-colors">
                {c.team}
              </h3>
              <p className="text-secondary-600 mb-6">
      ...
      <section className="py-20 bg-white">
        <div className="container-site">
          <h2 className="text-center text-2xl font-serif text-secondary-900 mb-12">{t('home.partners')}</h2>
          <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-12">
            {partners.map((partner, index) => (
              <a
                ...
                className="bg-cream p-4 hover:shadow-md transition-shadow"
              >
                <img
                  src={partner.logo}
                  alt={partner.name}
                  className="h-12 lg:h-16 w-auto object-contain grayscale hover:grayscale-0 transition-all"
                />
              </a>
            ))}
          </div>
