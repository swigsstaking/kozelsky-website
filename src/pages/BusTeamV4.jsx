    ...
    <>
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center">
        ...
        <div className="container-site relative z-10 text-white">
          ...
          <p className="text-3xl text-white/80 font-serif">{c.heroSubtitle}</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
            {c.values.map((value, index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-xl font-serif text-secondary-900 mb-3">{value.title}</h3>
      ...
      <section className="py-32 bg-white">
        <div className="container-site">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-5xl md:text-6xl font-serif text-secondary-900 mb-10">{c.dreamers}</h2>
            <p className="text-xl text-secondary-600 leading-relaxed mb-16">{c.dreamersDesc}</p>

            <div className="w-32 h-1 bg-accent-400 mx-auto my-16 rounded-full" />

            <h2 className="text-5xl md:text-6xl font-serif text-secondary-900 mb-10">{c.madeIt}</h2>
      ...
      <section className="py-32 bg-secondary-900 text-white">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-8">{c.companyCreation}</p>
              <h2 className="text-5xl font-serif mb-8">{c.kozelsky}</h2>
              <p className="text-secondary-300 leading-relaxed text-lg mb-10">{c.kozelskyCateringDesc}</p>
              <Link
                to="/catering"
