    ...
    <>
      ...
      <section className="py-32 bg-secondary-900">
        <div className="container-site text-center">
          <h2 className="text-5xl font-serif text-white mb-8">{c.atYourService}</h2>
          <p className="text-secondary-400 max-w-2xl mx-auto text-xl">{c.atYourServiceDesc}</p>
        </div>
      </section>
        ...
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {c.services.map((service, index) => (
              <div key={index} className="p-12 bg-secondary-900 hover:bg-secondary-700 transition-colors group">
                ...
                <p className="text-secondary-400 group-hover:text-secondary-300 text-lg transition-colors">
                  {service.desc}
                </p>
              </div>
            ))}
        ...
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h2 className="text-5xl font-serif text-white mb-8">{c.pricing}</h2>
              <p className="text-secondary-300 leading-relaxed text-lg mb-12">{c.pricingDesc}</p>
              <div className="flex flex-col sm:flex-row gap-6">
                <a
                  href={`tel:${CONTACT.phone.replace(/\s/g, '')}`}
                  className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-accent-500 text-white hover:bg-accent-600 transition-colors font-medium"
                >
                  <Phone size={20} />
                  {CONTACT.phone}
                </a>
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 px-10 py-5 border border-white/30 text-white hover:bg-white/10 transition-colors"
                >
                  <Mail size={20} />
                  {CONTACT.email}
                </a>
      ...
      <section className="py-24 bg-secondary-800">
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <Link to="/bus-11-97/v5/history" className="group p-12 bg-secondary-900 hover:bg-secondary-700 transition-colors text-center">
              <h3 className="text-2xl font-serif text-white mb-4">
                {c.navHistory}
              </h3>
              <p className="text-secondary-500 group-hover:text-secondary-400 transition-colors">
