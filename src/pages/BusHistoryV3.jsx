...
const BusHistoryV3 = () => {
  ...
  return (
    <>
      ...
      {/* Timeline - Light contrast */}
      <section className="py-20 bg-cream text-secondary-900">
        <div className="container-site">
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            {c.timeline.map((item, index) => (
              <div key={index} className="text-center">
                <p className="text-4xl font-serif text-accent-600 mb-2">{item.year}</p>
                <h3 className="text-lg font-medium mb-1">{item.title}</h3>
                <p className="text-secondary-600 text-sm max-w-[150px]">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-secondary-900">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-4">{c.august2020}</p>
              <h2 className="text-4xl font-serif text-white mb-6">{c.birth}</h2>
              <p className="text-secondary-300 leading-relaxed">{c.birthDesc}</p>
            </div>
            <Grid2x2Gallery
        ...
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-4">2021</p>
              <h2 className="text-4xl font-serif text-white mb-6">{c.transport}</h2>
              <p className="text-secondary-300 leading-relaxed">{c.transportDesc}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-secondary-900">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-4">2022</p>
              <h2 className="text-4xl font-serif text-white mb-6">{c.renovation}</h2>
              <p className="text-secondary-300 leading-relaxed">{c.renovationDesc}</p>
            </div>
            <Grid2x2Gallery
      ...
      {/* Finish - Light contrast */}
      <section className="py-24 bg-cream text-secondary-900">
        <div className="container-site text-center">
          <p className="text-accent-600 uppercase tracking-[0.3em] text-sm mb-4">{c.valaisFair}</p>
          <h2 className="text-4xl md:text-5xl font-serif mb-6">{c.finish}</h2>
          <p className="text-secondary-600 max-w-2xl mx-auto leading-relaxed">{c.finishDesc}</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-secondary-900">
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link to="/bus-11-97/v3/services" className="group p-8 bg-secondary-800 hover:bg-cream transition-colors text-center">
              <h3 className="text-xl font-serif text-white group-hover:text-secondary-900 mb-2 transition-colors">
                {c.navServices}
              </h3>
              <p className="text-secondary-400 group-hover:text-secondary-600 text-sm transition-colors">
