    ...
    <>
      ...
      <section className="py-20 bg-cream">
        <div className="container-site text-center">
          <h2 className="text-4xl font-serif text-secondary-900 mb-6">{c.atYourService}</h2>
          <p className="text-secondary-600 max-w-2xl mx-auto text-lg">{c.atYourServiceDesc}</p>
        </div>
      </section>
        ...
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {c.services.map((service, index) => (
              <div key={index} className="p-8 bg-cream hover:bg-secondary-900 group transition-colors">
                <div className="w-14 h-14 bg-accent-600 rounded-full flex items-center justify-center mb-6">
                  <service.icon size={24} className="text-white" />
                </div>
                <h3 className="text-xl font-serif text-secondary-900 group-hover:text-white mb-3 transition-colors">
                  {service.title}
                </h3>
      ...
      <section className="py-24 bg-secondary-900 text-white">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-6">{c.pricingLabel}</p>
              <h2 className="text-4xl font-serif mb-6">{c.pricing}</h2>
              <p className="text-secondary-300 leading-relaxed mb-8">{c.pricingDesc}</p>
