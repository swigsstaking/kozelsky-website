    ...
    <>
          ...
          <div className="flex flex-wrap justify-center gap-12 md:gap-20">
            {c.timeline.map((item, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-secondary-500 max-w-[180px]">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-40 bg-secondary-800">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-6">{c.august2020}</p>
              <h2 className="text-5xl font-serif text-white mb-8">{c.birth}</h2>
              <p className="text-secondary-300 leading-relaxed text-lg">{c.birthDesc}</p>
            </div>
            <Grid2x2Gallery
        ...
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-6">2021</p>
              <h2 className="text-5xl font-serif text-white mb-8">{c.transport}</h2>
              <p className="text-secondary-300 leading-relaxed text-lg">{c.transportDesc}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-40 bg-secondary-800">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-6">2022</p>
              <h2 className="text-5xl font-serif text-white mb-8">{c.renovation}</h2>
              <p className="text-secondary-300 leading-relaxed text-lg">{c.renovationDesc}</p>
            </div>
            <Grid2x2Gallery
      ...
      <section className="py-40 bg-secondary-900">
        <div className="container-site text-center">
          ...
          <h2 className="text-5xl md:text-6xl font-serif text-white mb-10">{c.finish}</h2>
      ...
      <section className="py-24 bg-secondary-800">
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <Link to="/bus-11-97/v5/equipment" className="group p-12 bg-secondary-900 hover:bg-secondary-700 transition-colors text-center">
            ...
            <Link to="/bus-11-97/v5/services" className="group p-12 bg-secondary-900 hover:bg-secondary-700 transition-colors text-center">
              <h3 className="text-2xl font-serif text-white mb-4">
                {c.navServices}
              </h3>
              <p className="text-secondary-500 group-hover:text-secondary-400 transition-colors">
            ...
            <Link to="/bus-11-97/v5/team" className="group p-12 bg-secondary-900 hover:bg-secondary-700 transition-colors text-center">
              <h3 className="text-2xl font-serif text-white mb-4">
                {c.navTeam}
              </h3>
              <p className="text-secondary-500 group-hover:text-secondary-400 transition-colors">
