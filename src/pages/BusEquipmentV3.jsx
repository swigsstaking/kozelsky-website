...
const BusEquipmentV3 = () => {
  ...
  return (
    <>
      ...
      {/* Lower Deck - Light contrast */}
      <section className="py-24 bg-cream text-secondary-900">
        <div className="container-site">
          <div className="text-center mb-16">
            <p className="text-accent-600 uppercase tracking-[0.3em] text-sm mb-4">{c.groundFloor}</p>
            <h2 className="text-4xl md:text-5xl font-serif mb-6">{c.lowerDeck}</h2>
            <p className="text-secondary-600 max-w-2xl mx-auto">{c.lowerDeckDesc}</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {c.equipmentLower.map((item, index) => (
              <div key={index} className="text-center">
                <div className="w-16 h-16 border border-secondary-900 rounded-full flex items-center justify-center mx-auto mb-4">
                  <item.icon size={28} className="text-secondary-900" />
                </div>
      ...
      <section className="py-24 bg-secondary-900">
        <div className="container-site">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-accent-400 uppercase tracking-[0.3em] text-sm mb-4">{c.firstFloor}</p>
              <h2 className="text-4xl font-serif text-white mb-6">{c.upperDeck}</h2>
              <p className="text-secondary-300 leading-relaxed mb-8">{c.upperDeckDesc}</p>
              <ul className="space-y-4">
                {c.upperDeckFeatures.map((feature, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <Check size={20} className="text-accent-400 mt-0.5 flex-shrink-0" />
      ...
      <section className="py-16 bg-secondary-800">
        <div className="container-site">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link to="/bus-11-97/v3/services" className="group p-8 bg-secondary-900 hover:bg-cream transition-colors text-center">
            ...
            <Link to="/bus-11-97/v3/team" className="group p-8 bg-secondary-900 hover:bg-cream transition-colors text-center">
              <h3 className="text-xl font-serif text-white group-hover:text-secondary-900 mb-2 transition-colors">
                {c.navTeam}
              </h3>
              <p className="text-secondary-400 group-hover:text-secondary-600 text-sm transition-colors">
            ...
            <Link to="/bus-11-97/v3/history" className="group p-8 bg-secondary-900 hover:bg-cream transition-colors text-center">
              <h3 className="text-xl font-serif text-white group-hover:text-secondary-900 mb-2 transition-colors">
                {c.navHistory}
              </h3>
              <p className="text-secondary-400 group-hover:text-secondary-600 text-sm transition-colors">
